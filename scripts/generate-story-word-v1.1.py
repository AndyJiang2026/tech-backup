...
# -*- coding: utf-8 -*-
"""
重新生成《长征·英雄》VR 大空间体验馆故事梗概 Word 文档 V1.1
新增：下篇第四章 四渡赤水
"""
...
def create_word_document():
    ...
    tasks = [
        '🎯 护送电台：20 人协同护送电台，炮火中规划行军路线',
        '🎯 四渡赤水：参与佯动战术决策，20 人协同渡河作战',
    ...
    stages = [
        ...
        ('课中沉浸', '20 人分组完成"湘江突围""四渡赤水""飞夺泸定桥"任务', '50 分钟'),
    ...
    end_info.add_run('版本号：V1.1（新增四渡赤水）\n')
    ...
    # 保存文档
    doc.save('/home/admin/.openclaw/workspace-chief-agent/长征 - 英雄 - 故事梗概展播版 V1.1.docx')
    print('✅ Word 文档 V1.1 生成成功：长征 - 英雄 - 故事梗概展播版 V1.1.docx')
