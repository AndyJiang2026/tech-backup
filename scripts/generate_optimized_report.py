#!/usr/bin/env python3
# -*- coding: utf-8 -*-
"""生成 XR 项目立项报告 Word 文档（优化润色版·数据来源标注）"""
...
def create_report():
    ...
    p = doc.add_paragraph()
    p.add_run('    河南电视台《唐宫夜宴》VR 项目已验证模式可行。根据公开报道及行业调研数据：')
    p.paragraph_format.line_spacing_rule = WD_LINE_SPACING.ONE_POINT_FIVE
    ...
    # 保存文档
    doc.save('reports/XR 项目立项报告（优化润色版）.docx')
    print('✅ 优化润色版 Word 文档生成成功！')
    print('文件路径：/home/admin/.openclaw/workspace-chief-agent/reports/XR 项目立项报告（优化润色版）.docx')
