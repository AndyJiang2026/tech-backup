...
def create_report():
    ...
    run.font.bold = True
    run.font.size = Pt(12)
    run = p.add_run('"的特色发展之路、延续经营发展逆势上扬态势贡献融媒体力量。')
    run.font.size = Pt(12)
    p.paragraph_format.line_spacing_rule = WD_LINE_SPACING.ONE_POINT_FIVE
    ...
    # 保存文档
    doc.save('reports/XR 项目立项报告（最终润色版）.docx')
    print('✅ 最终润色版 Word 文档生成成功！')
    print('文件路径：/home/admin/.openclaw/workspace-chief-agent/reports/XR 项目立项报告（最终润色版）.docx')
